...
class NewsTableViewController: UITableViewController,UISearchBarDelegate {
    ...
    lazy var feedListLine: ListFeedLine = {
        return ListFeedLine.newsFeedLines()
    }()
    func updateView(){
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        searchBar.endEditing(true)
        performSegue(withIdentifier: "showWebsite2", sender: self)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Table Cell News", for: indexPath) as! NewsTableViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if(segue.identifier == "showWebsite2") {
