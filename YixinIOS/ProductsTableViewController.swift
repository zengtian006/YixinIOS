...
class ProductsTableViewController: UITableViewController,UISearchBarDelegate {
    ...
    lazy var feedListLine: ListFeedLine = {
        return ListFeedLine.productsFeedLines()
    }()
    func updateView(){
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        searchBar.endEditing(true)
        performSegue(withIdentifier: "showWebsite3", sender: self)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Table Cell Products", for: indexPath) as! ProductsTableViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if(segue.identifier == "showWebsite3") {
